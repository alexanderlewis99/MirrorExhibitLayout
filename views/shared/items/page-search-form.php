...
<form <?php echo tag_attributes($formAttributes); ?>>
    <?php //The 'Search for Keywords' text box ?>
    ...
    <?php //The 'Narrow by Specific Fields' text box and 'Add a Field' button ?>
    <div id="search-narrow-by-fields" class="field">
        ...
        //Here is where we actually build the search form for 'Narrow by Specific Fields'
    ...
    <?php //The 'Search by a range of ID#s' text box  ?>
    ...
    <div id="search-selects">
        <?php //The 'Search By Collection' text box  ?>
        <div class="field">
            <div class="two columns alpha">
        ...
        <?php //The 'Search By Type' text box  ?>
        <div class="field">
            <div class="two columns alpha">
        ...
        <?php //The 'Search By User' text box ?>
        <div class="field">
            <div class="two columns alpha">
        ...
        <?php //The 'Search By Tags' text box ?>
        <div class="field">
            <div class="two columns alpha">
    ...
    <?php //The 'Public/Non-Public' text box ?>
    <div class="field">
        <div class="two columns alpha">
    ...
    <?php //The 'Featured/Non-Featured' text box ?>
    <div class="field">
        <div class="two columns alpha">
    ...
    <?php //The 'admin_items_search' plugin_hook allows for a search by exhibit text box ?>
    </div>
    <?php fire_plugin_hook('admin_items_search', array('view' => $this)); ?>

    <?php //The 'Search for items' button ?>
    </div>
    ...
    <input type="submit" class="submit big green button" name="submit_search" id="submit_search_advanced" value="<?php echo $buttonText; ?>">
    <?php endif; ?>
    <?php //End of code for the 'Search for items' button ?>
